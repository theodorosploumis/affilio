...
function mothership_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  /* ----------------------------- JS files ----------------------------- */
    ...
    $form['js']['Libraries']['mothership_modernizr'] = array(
      ...
      <a href="http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.7.1/modernizr.min.js">http://cdnjs.cloudflare.com/ajax/libs/modernizr/2.7.1/modernizr.min.js</a>
      <br>
  ...
  $form['css']['reset']['mothership_css_contextual'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Override Contextual Links'),
    '#description'   => t('Override default contextual links CSS and JS'),
    '#default_value' => theme_get_setting('mothership_css_contextual')
  );
 ...
 //Form
  $form['classes']['form'] = array(
    ...
    '#collapsed' => FALSE,
    '#description'   => t('
      a form field is constructed of multple loops that creates the "very rich markup(tm)" that drupal prides itself of :<br>

      <b>outerform (wrapper)</b>: <br>
      &lt;div
      class="field-type-<i>[type] </i>
      field-name-field-<i>[fieldname] </i>
      field-widget-<i>[widget] </i>
      <i>form-wrapper</i>"
      id="edit-field-banner-type-id"
      &gt;
      <br>

      <b>(a wrapper if theres multiple fields)</b> <br>
      &lt;div id="field-[fieldname]-add-more-wrapper"&gt; :
      <br>
      <b>Fieldwrapper</b> <br>
      &lt;div
      class="
      <i>form-item</i>
      form-type-<i>[type]</i>
      form-item-<i>[fieldname]-und-0-value</i>
      form-required
      "
      &gt;
      <br>
	...
	$form['classes']['form']['container'] = array(
	  '#type'          => 'fieldset',
	  '#title'         => t('Outer Form element wrapper'),
	  '#description'   => t('
      remove classes from the form elements wrapper:<br>
      '),
	  '#collapsible' => FALSE,
	);
  ...
  //---------------- Theme styles
  $form['themestyles'] = array(
    '#type'          => 'fieldset',
    '#title'         => '&#9733; ' . t('Theme panel styles'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
    '#weight'=> -10
  );

  $form['themestyles']['motherstyle_markup'] = array(
    '#type'  => 'textarea',
    '#title'         => t('Motherstyle markup'),
    '#description'   => t('seperate the markup elements with space.
     <p>div, header, footer, nav</p>'),
    '#default_value' => theme_get_setting('motherstyle_markup'),
  );

  $form['themestyles']['motherstyle_role'] = array(
    '#type'  => 'textarea',
    '#title'         => t('Motherstyle role'),
    '#description'   => t('seperate the roles with a space.
     <p>navigation, main</p>'),
    '#default_value' => theme_get_setting('motherstyle_role'),
  );


  $form['themestyles']['motherstyle_class'] = array(
    '#type'  => 'textarea',
    '#title'         => t('Motherstyle pane classes'),
    '#description'   => t('Seperate the classes by space.
     <p>the classes can be used in the motherstyle panel style fx a grid system etc fx: l-grid-3, l-grid-5, grid-3col-2-whatever'),
    '#default_value' => theme_get_setting('motherstyle_class'),
  );
