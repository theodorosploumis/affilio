...
<?php if (theme_get_setting('mothership_poorthemers_helper')) { ?>
  <!-- tpl: templates/panels/mothership-3colstacked/mothership-3colstacked.tpl.php -->
<?php } ?>
...
if (arg(0) == "admin") {
  ...
  <div class="panel-display" <?php if (!empty($css_id)) {
    ...
    <div class="panel-panel panel-col-100">
      ...
      <div class="panel-panel panel-col-25">
        <div class="inside"><?php print $content['main3']; ?></div>
      </div>
    </div>
...
<?php
  ...
  <article class="lr-3col" <?php if (!empty($css_id)) {
    print "id=\"$css_id\"";
  } ?>>
    ...
    <?php if ($content['main3']): ?>
      <aside class="l-sidebar2"><?php print $content['main3']; ?></aside>
    <?php endif; ?>
